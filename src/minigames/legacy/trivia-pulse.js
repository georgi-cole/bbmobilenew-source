...
(function(g){
  ...
  const QUESTIONS = [
    ...
    { q: 'What happens to eligible standard eliminations once the Tribunal starts?', a: ['They leave permanently', 'They join the Tribunal', 'They become finalists', 'They gain immunity'], correct: 1, difficulty: 'medium' },
    ...
    { q: 'How many Tribunal members vote in a standard 16-player Classic season?', a: ['7', '9', '5', '11'], correct: 1, difficulty: 'medium' },
