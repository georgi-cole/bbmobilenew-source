...
import gameReducer, { advance, completeMinigame, launchMinigame } from '../src/store/gameSlice'
import challengeReducer, { completeChallenge, startChallenge } from '../src/store/challengeSlice'
...
describe('completeChallenge — positive-score winner preference', () => {
  ...
  it('selects a positive-score winner over zero-score participants', () => {
    ...
    store.dispatch(startChallenge(42, ['p0', 'p1', 'p2'], { forceGameKey: 'quickTap' }))
  ...
  it('returns the highest positive scorer when multiple compete', () => {
    ...
    store.dispatch(startChallenge(10, ['p0', 'p1', 'p2'], { forceGameKey: 'quickTap' }))
  ...
  it('returns a winner even when all scores are zero', () => {
    ...
    store.dispatch(startChallenge(99, ['p0', 'p1', 'p2'], { forceGameKey: 'quickTap' }))
  ...
  it('uses an authoritative winner override when a React minigame reports one', () => {
    ...
    store.dispatch(startChallenge(77, ['p0', 'p1', 'p2'], { forceGameKey: 'quickTap' }))
