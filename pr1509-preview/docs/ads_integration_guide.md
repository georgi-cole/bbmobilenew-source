...
**Important:** only call `window.onAdRewardGranted` when the user actually _completed_ the ad. If they skip or the ad fails, do not call it — the game will not grant the reward.
