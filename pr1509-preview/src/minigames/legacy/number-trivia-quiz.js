...
;(function (g) {
  ...
  const QUESTIONS = [
    ...
    {
      q: 'How many days does a typical The Big Eye housemate stay before early elimination?',
      a: 14,
    },
  ...
  function render(container, onComplete, options = {}) {
    ...
    statsDiv.style.cssText =
      'display:flex;gap:20px;font-size:0.95rem;flex-wrap:wrap;justify-content:center;'
    ...
    questionDiv.style.cssText =
      'min-height:80px;font-size:1.1rem;color:#e3ecf5;text-align:center;padding:15px;background:#1a2a3a;border-radius:10px;border:2px solid #5bd68a;max-width:100%;'
    questionDiv.textContent = currentQuestion.q

    const hintDiv = document.createElement('div')
    hintDiv.textContent = 'Enter your answer below'
    hintDiv.style.cssText =
      'min-height:30px;font-size:1rem;color:#95a9c0;text-align:center;font-weight:500;'
