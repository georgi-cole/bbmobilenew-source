// src/data/houseguests.ts
// Canonical houseguest dataset ported from bbmobile/js/data/houseguests.js
...
const HOUSEGUESTS: Houseguest[] = [
  ...
  },
  {
    ...
    sexuality: 'Straight',
    education: 'Bachelor of Outdoor Education',
    profession: 'Outdoor Survival Instructor',
    familyStatus: 'Single',
    kids: 'None',
    pets: 'Dog named Scout',
  ...
  },
  {
    ...
    profession: 'Fashion Creative Producer',
    familyStatus: 'Single',
    kids: 'None',
    pets: 'None',
    zodiacSign: 'Leo',
  ...
  },
  {
    ...
    story: `Remy Bouchard can sell anything to anyone—it's his gift and his curse. As a Brand Strategist in Montreal's competitive marketing scene, he's made millions for clients by understanding exactly what people want to hear. His jazz saxophone performances at underground clubs show a different side—creative, passionate, authentic. But which is the real Remy? Even he doesn't know anymore. He's worn so many masks for so long that his own reflection feels like a stranger. His last relationship ended when his girlfriend said she felt like she was dating a commercial, not a person. His childhood friends barely recognize the polished professional he's become. The Big Eye represents his biggest brand challenge yet: marketing himself while actually being himself. In a game where everyone is performing for the cameras, can a professional performer remember how to be genuine? Or will he charm his way to the end only to realize he's won as someone else entirely?`,
  },
  {
    id: 'blue',
    name: 'Blue',
    fullName: 'Blue Rivers',
    age: 31,
    sex: 'Male',
    location: 'New York, USA',
    sexuality: 'Straight',
    education: 'Master of Systems Engineering',
  ...
  },
  {
    ...
    story: `Jax Silva's body is a temple he built from ruins. As a Performance Coach in Rio, he pushes athletes to their absolute limits because he knows exactly what those limits feel like. His Ironman finishes aren't just accomplishments—they're middle fingers to the overweight, bullied teenager he used to be. Every sunrise workout, every punishing training session, every competition is war against his former self. But the war never ends. Despite his transformed physique and successful coaching business, he still sees the fat kid in the mirror. His relationships fail because partners grow tired of competing with his obsession. His family worries that he's replaced one extreme with another. The Big Eye is his ultimate test: stripped of his routine, his gym, his control, can he prove his strength comes from within rather than from the weights he lifts? In a game of endurance, the Ironman thinks he has every advantage. But when the competition is social rather than physical, will pushing his limits finally break him?`,
  },
  {
    id: 'echo',
    name: 'Echo',
    fullName: 'Echo Holloway',
    age: 22,
    sex: 'Female',
    location: 'London, UK',
    sexuality: 'Straight',
    education: 'Bachelor of Audio Engineering',
    profession: 'Audio Archivist',
    familyStatus: 'Single',
    kids: 'None',
    pets: 'Three cats',
    zodiacSign: 'Aquarius',
  ...
  },
  {
    ...
    sexuality: 'Straight',
    education: 'Bachelor of Business Strategy',
    profession: 'Strategy Intern',
    familyStatus: 'Single',
    kids: 'None',
    pets: 'None',
    zodiacSign: 'Libra',
    ...
    story: `Vee Nkosi brews the perfect cup of coffee—Ethiopian pour-over, South African rooibos, Colombian cold brew—each one a meditation, a moment of control in a life that often feels chaotic. As a Strategy Intern at a Cape Town consulting firm, she's brilliantly good at solving other people's problems while her own pile up like unopened mail. Her craft coffee obsession started as a pandemic hobby and became an escape hatch from expectations she can't meet. Peace and strategy, her dual mantras, feel increasingly contradictory. Her parents invested everything in her education; her siblings look up to her; her friends think she has it all figured out. But Vee feels like a fraud playing dress-up in someone else's life. The Big Eye is her pressure test: can she strategize her way through the game while maintaining her inner peace? Or will the conflict between her image and her reality finally boil over like an unwatched espresso machine?`,
  },
  {
    id: 'sol',
    name: 'Sol',
    fullName: 'Sol Martinez',
    age: 26,
    sex: 'Male',
    location: 'Madrid, Spain',
    sexuality: 'Straight',
    education: 'Bachelor of Media Production',
    profession: 'Media Editor',
    familyStatus: 'Single',
    kids: 'None',
    pets: 'None',
    zodiacSign: 'Leo',
  ...
  },
  {
    ...
    story: `Aria Colombo's hands move across harp strings like water flowing over stones—fluid, inevitable, beautiful. At Rome's prestigious conservatory, she studies classical music while struggling to pay rent by performing at weddings and tourist hotels. Her philosophy of harmony first extends beyond music; she mediates every conflict, smooths every rough edge, sacrifices her own comfort for group peace. But people-pleasing isn't the same as harmony—it's just silence wearing a pleasant mask. She learned young that keeping quiet kept her safe; her parents' explosive fights taught her that raising her voice meant everything falling apart. Now at 23, she's so good at being agreeable that she's lost track of what she actually wants. The Big Eye is her crescendo: a game where conflict is inevitable, where harmony must be earned rather than enforced. In a house designed to create drama, can someone who's spent her life avoiding it finally learn that real harmony includes discord? Or will her need to keep the peace make her everyone's pawn?`,
  },
  {
    id: 'dex',
    name: 'Dex',
    fullName: 'Dex Andersson',
    age: 30,
    sex: 'Male',
  ...
  },
  {
    ...
    zodiacSign: 'Taurus',
    religion: 'Catholic',
    motto: 'Build cities for people, not cars',
...
export function getById(id: string): Houseguest | undefined {
  return HOUSEGUESTS.find((h) => h.id === id.toLowerCase())
}

export function findByName(name: string): Houseguest | undefined {
  const lower = name.toLowerCase()
  return HOUSEGUESTS.find((h) => h.name.toLowerCase() === lower)
}
